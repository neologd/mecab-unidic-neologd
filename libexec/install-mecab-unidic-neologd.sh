...
ECHO_PREFIX="[install-mecab-unidic-neologd] :"
GREP_OPTIONS=""
...
BUILT_DIC_DIR=${BASEDIR}/../build/unidic-mecab-2.1.2_src-neologd-${YMD}
...
if [ -e ${INSTALL_DIR_PATH} ]; then
    ...
    echo "${ECHO_PREFIX} Usage of mecab-unidic-neologd is here."
    echo "Usage:"
